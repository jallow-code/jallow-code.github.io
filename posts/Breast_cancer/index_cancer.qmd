...
# Plot ROC Curves
plot(roc_glm, col = "blue", lwd = 3, percent = TRUE,
     main = "ROC Curve Comparison",
     xlab = "False Positive rate", 
     ylab = "True Positive rate", 
     legacy.axes = TRUE)

plot(roc_knn, col = "green", lwd = 3, percent = TRUE, add = T)

plot(roc_lda, col = "#d7191c", lwd = 3, percent = TRUE, add = T)

plot(roc_qda, col = "#fdae61", lwd = 3, percent = TRUE, add = T)

plot(roc_nb, col = "purple", lwd = 3, percent = TRUE, add = T)

# Add Legend with AUC values
legend("bottomright", 
       legend = c(
         paste("Logistic Regression (AUC =", auc_glm, ")"),
         paste("KNN (AUC =", auc_knn, ")"),
         paste("LDA (AUC =", auc_lda, ")"),
         paste("QDA (AUC =", auc_qda, ")"),
         paste("Naive Bayes (AUC =", auc_nb, ")")
       ), 
       col = c("blue", "green", "#d7191c", "#fdae61", "purple"), 
       lwd = 2)
...
The ROC curve shows the trade-off between sensitivity and specificity across varying classification thresholds. Logistic Regression and KNN achieved an AUC of 1, indicating perfect classification performance. LDA, QDA, and Naive Bayes also performed strongly with AUC values close to 1.

For imbalanced datasets, where the minority class is of primary importance, additional metrics such as Precision-Recall curves might be helpful. However, in this dataset, the AUC-ROC curve effectively captures the models' discrimination abilities.
...
Accuracy complements AUC by providing a direct measure of model performance on correctly classified instances. Logistic Regression emerged as the most accurate model. KNN and LDA followed closely, with QDA and Naive Bayes showing slightly lower accuracy.

## Conclusion

In conclusion, the AUC-ROC curve provided a comprehensive view of the classification models' performance. Logistic Regression consistently outperformed other models, achieving perfect scores across AUC and accuracy metrics. Therefore, logistic regression emerges as the preferred model for this breast cancer dataset.
